...
?>
    ...
    <head>
        ...
        <meta name="generator" content="Atom, VS" />
        ...
        <?php
            if (isset($_POST['cadastrar'])) {
              ...
              if (!Validacao::validarBrand($_POST['brand'])) {
                $erros[] = "<script>window.alert('Marca Inválido, tente novamente');</script>";
              } //fecha if validar marca

              if (!Validacao::validarEquityNumber($_POST['equityNumber'])) {
                $erros[] = "<script>window.alert('atrimônio Inválido, tente novamente');</script>";
              ...
              $impressora->brand = Padronizacao::padronizarNome($_POST['brand']);
              $impressora->model = Padronizacao::padronizarNome($_POST['model']);
              $impressora->serie = Padronizacao::padronizarSerie($_POST['serie']);
