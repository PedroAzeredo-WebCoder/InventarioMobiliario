...
<div class="jumbotron jumbotron-fluid" style="width:90%; background-color:rgba(252, 245, 245, 1); border-radius: 10px; box-shadow: 9px 7px 5px rgba(50, 50, 50, 0.77); margin-left: auto; margin-right: auto; margin-top: 7%;">
    <form name="cad" method="post" action="alterarImpressora.php">
        ...
        <div class="col">
          ...
          <div class="sn garantia">
            <div class="custom-control custom-radio">
              <input type="radio" class="custom-control-input" id="defaultUnchecked" name="warranty" value="Sim" <?php if (isset($impressora)) if ($impressora->warranty == 'Sim') echo 'checked'; ?>>
              <label class="custom-control-label form-check-inline" for="defaultUnchecked">Sim</label>
            </div>
            <div class="custom-control custom-radio">
              <input type="radio" class="custom-control-input" id="defaultChecked" name="warranty" value="Não" <?php if (isset($impressora)) if ($impressora->warranty == 'Não') echo 'checked'; ?>>
      ...
      <div class="form-group">
        ...
        <div class="box">
          <input type="text" name="equityNumber" class="form-control" pattern="^[0-9]{5,7}$" value="<?php if (isset($impressora)) echo $impressora->equityNumber; ?>" required>
        </div>
      </div>
