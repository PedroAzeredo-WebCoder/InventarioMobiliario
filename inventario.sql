...
VALUES
  ...
  (
    ...
    01,
    'FATURAMENTO',
    'Chefia Faturamento E PatrimÃ´nio',
    'Positivo',
    'W2043S',
    'TCH3519330220432827',
    'PMPA',
  ...
  (
    040,
    01,
    'MANUTENÇÃO BIOMÉTRICA',
    'Manutenção Biomédica',
    'Positivo',
    'W1946PW',
    '20328127',
    'PMPA',
...
ADD
  UNIQUE KEY `namePrinter` (`namePrinter`),
ADD
  UNIQUE KEY `serie` (`serie`),
ADD
  UNIQUE KEY `ip` (`ip`),
ADD
  UNIQUE KEY `equityNumber` (`equityNumber`);
...
ADD
  UNIQUE KEY `serie` (`serie`),
ADD
  UNIQUE KEY `numberScore` (`numberScore`),
ADD
...
ALTER TABLE
  `impressora`
MODIFY
  `idImpressora` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
  `micro`
MODIFY
  `idMicro` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
  `monitor`
MODIFY
  `idMonitor` int(3) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 104;
