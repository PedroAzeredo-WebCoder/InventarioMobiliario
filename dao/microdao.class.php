  ...
  private $conexao = null;
    ...
    public function filtrarMicro($pesquisa, $filtro)
    {
        try {
          ...
          $query = "";
          switch($filtro) {
            case "idMicro": $query = "where idMicro = ".$pesquisa;
            break;
            case "numberComputer": $query = "where numberComputer like '%".$pesquisa."%'";
            break;
            case "setor": $query = "where setor like '%".$pesquisa."%'";
            break;
            case "patrimony": $query = "where patrimony like '%".$pesquisa."%'";
            break;
            case "name": $query = "where name like '%".$pesquisa."%'";
            break;
            case "ip": $query = "where ip like '%".$pesquisa."%'";
            break;
            case "numberScore": $query = "where numberScore like '%".$pesquisa."%'";
            break;
            default: $query = "";
            break;
          }//fecha switch
